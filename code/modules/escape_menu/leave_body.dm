...
/datum/escape_menu/proc/leave_ghost()
	...
	// Not guaranteed to be living. Everything defines verb/ghost separately. bad you.
...
/datum/escape_menu/proc/leave_suicide()
	...
	// Not guaranteed to be human. Everything defines verb/suicide separately. bad you, still.
