...
/datum/storage/explosive_pouch
	max_specific_storage = WEIGHT_CLASS_SMALL
	max_total_storage = 6
	max_slots = 3

/datum/storage/explosive_pouch/New(atom/parent, max_slots, max_specific_storage, max_total_storage)
	. = ..()
	set_holdable(list(
		/obj/item/grenade,
	))
...
/obj/item/storage/tgmc_pouch/explosive_pouch
	...
	storage_type = /datum/storage/explosive_pouch

/datum/storage/explosive_pouch/grenade
...
/obj/item/storage/tgmc_pouch/grenade_pouch
	...
	icon_state = "grenade"
	storage_type = /datum/storage/explosive_pouch/grenade

/datum/storage/medipen_pouch
	max_specific_storage = WEIGHT_CLASS_SMALL
	max_total_storage = 10
	max_slots = 5

/datum/storage/medipen_pouch/New(atom/parent, max_slots, max_specific_storage, max_total_storage)
	. = ..()
	set_holdable(list(
...
/obj/item/storage/tgmc_pouch/medipen_pouch
	...
	storage_type = /datum/storage/medipen_pouch
