...
/obj/item/fish
	...
	/// Needed fluid type for this fish to live.
	var/required_fluid_type = AQUARIUM_FLUID_FRESHWATER
	/// Needed minimum temperature for the fish to live.
...
/// Grinding a fish replaces some the protein it has with blood and gibs.. You is not getting a clean smoothie out of it.
...
/obj/item/fish/proc/start_flopping()
	if(HAS_TRAIT(src, TRAIT_FISH_FLOPPING))  // Needs update_transform/animate_wrappers to be less restrictive.
		return
