...
/mob/living/basic/slime/Initialize(mapload, new_colour="grey", new_is_adult=FALSE)
...
/mob/living/basic/slime/regenerate_icons()
	...
	var/icon_feed = "[icon_text] eat"
	if(stat != DEAD)
		icon_state = icon_text
		if(buckled)
			icon_state = icon_feed
		if(mood && !stat)
...
/mob/living/basic/slime/Process_Spacemove(movement_dir = 0)
	return 2
...
/mob/living/basic/slime/attack_slime(mob/living/basic/slime/M)
...
/mob/living/basic/slime/attack_animal(mob/living/simple_animal/user, list/modifiers)
	. = ..()
	if(.)
		attacked += 10
...
/mob/living/basic/slime/attack_larva(mob/living/carbon/alien/larva/L)
...
/mob/living/basic/slime/attack_alien(mob/living/carbon/alien/humanoid/user, list/modifiers)
...
/mob/living/basic/slime/proc/add_friendship(new_friend, amount = 1)
...
/mob/living/basic/slime/proc/set_friendship(new_friend, amount = 1)
	Friends[new_friend] = amount
	if(new_friend)
		RegisterSignal(new_friend, COMSIG_PARENT_QDELETING, .proc/clear_memories_of, override = TRUE)

/mob/living/basic/slime/proc/remove_friend(friend)
	Friends -= friend
...
/mob/living/basic/slime/proc/clear_memories_of(datum/source)
	SIGNAL_HANDLER
	if(source == Target)
		set_target(null)
	if(source == Leader)
