...
/datum/chemical_reaction/drink/hiveminderaser
	...
	required_reagents = list(/datum/reagent/consumable/ethanol/black_russian = 2, /datum/reagent/consumable/ethanol/krakenblast = 1, /datum/reagent/consumable/grenadine = 1)
...
/datum/chemical_reaction/drink/krakenblast
	results = list(/datum/reagent/consumable/ethanol/krakenblast = 3)
