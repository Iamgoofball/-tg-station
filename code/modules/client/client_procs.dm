...
/client/New(TopicData)
	...
	var/cached_player_age = set_client_age_from_db(tdata) //we have to cache this because other bad may change it and we need its current value now down below.
...
//Like for /atoms, but clients are their own snowflake bad
