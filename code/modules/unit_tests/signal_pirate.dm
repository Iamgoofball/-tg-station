...
/datum/unit_test/signal_pirate/Run()
	...
	var/list/maintenance_audit = network_terminal.compile_network_audit(FALSE)
	TEST_ASSERT(maintenance_audit["endpoints"] >= 1, "The maintenance audit did not discover NTNet endpoints.")
