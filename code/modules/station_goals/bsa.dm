...
/obj/machinery/bsa/full
	...
	var/list/obj/structure/filler/fillers
...
/obj/machinery/bsa/full/New(loc,cannon_direction = WEST)
	...
	fillers = list()
	for(var/turf/T in (getline(get_back_turf(),get_turf(src)) | getline(get_front_turf(),get_turf(src))))
		var/obj/structure/filler/F = new/obj/structure/filler(T)
		F.parent = src
		fillers += F
