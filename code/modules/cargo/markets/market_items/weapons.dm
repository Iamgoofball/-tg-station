...
/datum/market_item/weapon/surplus_esword
	name = "Pattern I 'Iaito' plasma blade"
	desc = "A mass-produced plasma blade. It is functionally worse than a milspec plasma blade commonly found amongst paramilitary organizations. \
