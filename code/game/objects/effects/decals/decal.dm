...
/obj/effect/turf_decal/Initialize(mapload)
	...
	T.AddElement(/datum/element/decal, icon, icon_state, dir, null, layer, alpha, color, null, FALSE, null, _pixel_x = pixel_x, _pixel_y = pixel_y)
	return INITIALIZE_HINT_QDEL
...
// I hate it too bestie
	if(GLOB.running_create_and_destroy)
		var/turf/T = loc
		T.RemoveElement(/datum/element/decal, icon, icon_state, dir, null, layer, alpha, color, null, FALSE, null, _pixel_x = pixel_x, _pixel_y = pixel_y)
#endif
