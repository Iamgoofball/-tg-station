...
#define POWER_PENALTY_THRESHOLD 5000 //The cutoff on power properly doing damage, pulling bad around, and delamming into a tesla. Low chance of pyro anomalies, +2 bolts of electricity
