...
#define JOB_NETWORK_ENGINEER "Network Engineer"
...
#define JOB_DISPLAY_ORDER_NETWORK_ENGINEER 3
#define JOB_DISPLAY_ORDER_ATMOSPHERIC_TECHNICIAN 4
// Medical
