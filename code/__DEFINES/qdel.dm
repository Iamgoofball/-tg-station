...
#define GC_QUEUE_HARDDELETE 3 //! short queue f.. Things that hard delete instead of going through the gc subsystem, this is purely so if they *can* softdelete, they will soft delete rather then wasting time with a hard delete.
